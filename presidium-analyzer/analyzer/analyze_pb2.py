...
_RESULTS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='results',
            full_name='types.Results.results',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_ANALYZEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='value',
            full_name='types.AnalyzeRequest.value',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='fields',
            full_name='types.AnalyzeRequest.fields',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
AnalyzeRequest = _reflection.GeneratedProtocolMessageType(
    'AnalyzeRequest',
    (_message.Message, ),
    dict(
        DESCRIPTOR=_ANALYZEREQUEST,
