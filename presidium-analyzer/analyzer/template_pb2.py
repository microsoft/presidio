...
_ANALYZETEMPLATE.fields_by_name['fields'].enum_type = common__pb2._FIELDTYPES
_ANONYMIZETEMPLATE.fields_by_name['fieldTypeTransformations'].message_type = _FIELDTYPETRANSFORMATION
_FIELDTYPETRANSFORMATION.fields_by_name['fields'].enum_type = common__pb2._FIELDTYPES
