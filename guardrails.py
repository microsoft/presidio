...
class PiiEntityType(str, Enum):
    ...
    # Lithuania
    LT_PERSONAL_CODE = "LT_PERSONAL_CODE"
    LT_POSTAL_CODE = "LT_POSTAL_CODE"
...
PII_ENTITY_CATEGORIES_MAP = {
    ...
    PiiEntityCategory.LITHUANIA: [
        PiiEntityType.LT_PERSONAL_CODE,
        PiiEntityType.LT_POSTAL_CODE,
    ],
}
