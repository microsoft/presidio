from methods import get_image, compare_images
...
def test_given_image_with_text_and_fill_then_text_is_greyed_out():
    ...
    result_image = get_image("ocr_test_anonymized.png")
...
def test_given_image_with_text_and_matrix_fill_then_text_is_colored_out():
    image = get_image("ocr_test.png")
    expected_result_image = get_image("ocr_test_anonymized_matrix.png")
