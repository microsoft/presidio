...
### Analyzer
#### Added
- Generic `VIN` recognizer (`VinRecognizer`) for Vehicle Identification Numbers using pattern match, context, and North American mod-11 check-digit validation.
- Generic `IMEI` recognizer (`ImeiRecognizer`) for International Mobile Equipment Identity numbers using pattern match, context, and Luhn checksum validation.
