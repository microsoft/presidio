...
//AnonymizerJSONMockedObject anonymizer mock
type AnonymizerJSONMockedObject struct {
	mock.Mock
}
...
//GetJSONAnonymizerMockResult get anonymizer json mock response
func GetJSONAnonymizerMockResult() *types.AnonymizeResponse {
...
func GetTemplateMock() presidio.TemplatesStore {
	...
	templateService.On("GetTemplate", mock.Anything, store.Analyze, mock.Anything).
		...
		On("GetTemplate", mock.Anything, store.AnonymizeJSON, mock.Anything).
		Return(`{"jsonSchema": "{\"Name\":\"<PERSON>\"}"}`, nil)
