...
def main():
    """Example of using AHDS Surrogate operator with SurrogateOnly operation."""
    ...
    try:
        ...
        print("Note: Uses Azure Health Data Services SurrogateOnly operation for realistic surrogate generation")
