...
| Anonymize | custom | replace the PII with the result of the function executed on the PII | `new_value` - lambda to execute on the PII data. The lambda return type must be a string. |
