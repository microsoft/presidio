...
| FieldType  | Description                                                                                             | Detection Method                         |
|------------|---------------------------------------------------------------------------------------------------------|------------------------------------------|
| PH_HEALTH_INSURANCE | Philippine Health Insurance Corporation PhilHealth Identification Number (PIN): a 12-digit member identifier commonly written in 2-9-1 format (e.g., 12-000015726-6). | Pattern match, context, and checksum |
