...
class TransformersRecognizer(EntityRecognizer):
    ...
    def __init__(
        ...
        supported_entities: Optional[List[str]] = ["PERSON"],
    ):
    ...
    def load_transformer(self, **kwargs) -> None:
        ...
        :param keyword arguments - define default values for class attributes and modify pipeline behavior
    ...
    def split_text_to_word_chunks(input_length: int, chunk_length: int, overlap_length: int) -> List[List]:
        ...
        :param chunk_length: Length of each chunk of input_ids. Should match the max input length of the transformer model
    ...
    def _convert_to_recognizer_result(self, prediction_result: dict, explanation: str) -> RecognizerResult:
        ...
        transformers_results = RecognizerResult(
            ...
            score=round(prediction_result["score"], 2),
    ...
    def __check_label_transformer(self, label: str) -> str:
        """The function validates the predicted label is identified by Presidio and maps the string into a Presidio representation
        :param label: Predicted label by the model
        :type label: str
        :return: Returns the predicted entity if the label is found in model_to_presidio mapping dictionary and is supported by Presidio entities
        :rtype: str
        """
