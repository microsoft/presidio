...
In this part you can find how to create:
...
<div id="StorageSourceConnector"></div>
...
<div id="StreamSourceConnector"></div>
...
For similar sinks and code reuse follow the steps listed below.
...
For more information about scheduler usage: [scheduler readme](docs/tutorial_scheduler.md).
