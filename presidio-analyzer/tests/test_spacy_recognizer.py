...
class TestSpacyRecognizer(TestCase):
    ...
    def test_person_first_name_with_context(self):
        ...
        assert_result_within_score_range(
            results[0], entities[0], 11, 14, NER_STRENGTH,
    ...
    def test_person_full_name_with_context(self):
        ...
        assert len(results) == 1
        assert_result_within_score_range(
            results[0], entities[0], 0, 11, NER_STRENGTH,
            EntityRecognizer.MAX_SCORE)
    ...
    #     results = spacy_recognizer.analyze('{} {}'.format(context, name),
    #     entities)

    #     assert len(results) == 2
    #     assert_result_within_score_range(results[1], entities[1], 5, 12,
    #     NER_STRENGTH, EntityRecognizer.MAX_SCORE)
    #     assert_result_within_score_range(results[0], entities[0], 17, 23,
    #     NER_STRENGTH, EntityRecognizer.MAX_SCORE)
    ...
    def test_person_last_name_is_also_a_date_with_context_expected_person_only(
        ...
        assert_result_within_score_range(
            results[0], entities[0], 0, 7, NER_STRENGTH,
            EntityRecognizer.MAX_SCORE)
    ...
    def test_date_time_year_with_context(self):
        ...
        assert len(results) == 1
        assert_result_within_score_range(
            results[0], entities[1], 19, 23, NER_STRENGTH,
            EntityRecognizer.MAX_SCORE)
    ...
    def test_date_time_month_with_context(self):
        ...
        assert len(results) == 1
        assert_result_within_score_range(
            results[0], entities[1], 19, 22, NER_STRENGTH,
            EntityRecognizer.MAX_SCORE)
    ...
    def test_date_time_day_in_month(self):
        ...
        assert len(results) == 1
        assert_result_within_score_range(
            results[0], entities[1], 0, 7, NER_STRENGTH,
            EntityRecognizer.MAX_SCORE)
    ...
    def test_date_time_full_date(self):
        ...
        assert len(results) == 1
        assert_result_within_score_range(
            results[0], entities[1], 0, 13, NER_STRENGTH,
            EntityRecognizer.MAX_SCORE)
    ...
    def test_date_time_day_in_month_with_year_with_context(self):
        ...
        assert len(results) == 1
        assert_result_within_score_range(
            results[0], entities[1], 19, 32, NER_STRENGTH,
            EntityRecognizer.MAX_SCORE)
