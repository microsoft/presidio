...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            (),
            (),
        ),  # first digit 0, rest mathematically plausible
        ...
        (
            ...
            (),
            (),
        ),  # 10th digit wrong, single-digit mismatch
        (
            "11798724308",
            0,
            (),
            (),
        ),  # random entry, both 10th and 11th wrong
        ...
        (
            ...
            (),
            (),
        ),  # 10th correct, 11th wrong
        (
            "97485249605",
            0,
            (),
            (),
        ),  # OCR/typo scenario, single digit off
