...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Today is 5-MAY-2021", 2, ((9, 14),(9, 19)), ((0.6, 0.81),(0.6, 0.81)),),
        ("Today is 5-May-2021", 2, ((9, 14),(9, 19)), ((0.6, 0.81),(0.6, 0.81)),),
        ...
        ("Today is 05/21", 1, ((9, 14),), ((0, 0.05),),),
        ("Today is 5/21", 1, ((9, 13),), ((0, 0.05),),),
        ("Today is 5/2021", 1, ((9, 15),), ((0, 0.05),),),
        ("Today is 05/2021", 1, ((9, 16),), ((0, 0.05),),),
        # fmt: on
    ],
)
