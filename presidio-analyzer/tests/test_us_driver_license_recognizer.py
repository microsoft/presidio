...
#     results = us_license_recognizer.analyze_all(context + num, entities)
#
#     assert len(results) == 2
...
# TODO: Test will work with context
# def test_valid_us_driver_license_weak_alphanumeric():
#     num = 'H12234567'
#     results = us_license_recognizer.analyze_all(num, entities)
#
...
# TODO: Test will work with context
# def test_valid_us_driver_license_weak_alphanumeric_exact_context():
#     num = 'H12234567'
...
def test_invalid_us_driver_license():
    num = 'C12T345672'
    results = us_license_recognizer.analyze_all('my driver license is ' + num, entities)
...
#     text = text_file.read()
#     results = us_license_recognizer.analyze_all(text, entities)
#     assert len(results) == 1
