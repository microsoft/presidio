...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("My US number is (415) 555-0132, and my international one is +1 415 555 0132",
         ...
         ((16, 30), (60, 75),), 0.3),
        ("My Israeli number is 09-7625400", 1, ["PHONE_NUMBER"], ((21, 31), ), 0.3),
        ("_: (415)555-0132", 1, ["PHONE_NUMBER"], ((3, 16), ), 0.3),
        ("United States: (415)555-0132", 1, ["PHONE_NUMBER"], ((15, 28), ), 0.3),
        ("US: 415-555-0132", 1, ["PHONE_NUMBER"], ((4, 16), ), 0.3),  # 'us' stop word
        ("_: +55 11 98456 5666", 1, ["PHONE_NUMBER"], ((3, 20), ), 0.3),
        ("Brazil: +55 11 98456 5666", 1, ["PHONE_NUMBER"], ((8, 25), ), 0.3),
        ("BR: +55 11 98456 5666", 1, ["PHONE_NUMBER"], ((4, 21), ), 0.3),
        # fmt: on
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("My US number is (415) 555-0132, and my international one is415-555-0132",
         1, ["PHONE_NUMBER"], ((16, 30), ), 0.3, 1),
        ("My US number is (415) 555-0132, and my international one is415-555-0132",
         2, ["PHONE_NUMBER", "PHONE_NUMBER"], ((16, 30), (59, 71), ), 0.3, 0),

        ("My US number is (415) 555-0132, and my international one is 91-415-555-0132",
         1, ["PHONE_NUMBER"], ((16, 30), ), 0.3, 2),
        ("My US number is (415) 555-0132, and my international one is 91-415-555-0132",
        ...
        ("My US number is (415) 555-0132, and my international one is +91 4155550132",
         2, ["PHONE_NUMBER", "PHONE_NUMBER"], ((16, 30), (60, 74), ), 0.3, 3),
        # fmt: on
    ],
)
