...
# Test Name Entity
# Bug #617 : Spacy Recognizer doesn't recognize Dan as PERSON even though online stanza demo indicates that it does
# See http://textanalysisonline.com/stanza-named-entity-recognition-ner
# def test_person_first_name(self):
#     name = 'Dan'
#     results = stanza_recognizer.analyze(name, entities)
...
def test_person_first_name_with_context(nlp_engines, nlp_recognizers):
    nlp_engine = nlp_engines["stanza_en"]
    nlp_recognizer = nlp_recognizers["stanza"]
    name = 'Dan'
    context = 'my name is'
