...
class TestStanzaBatchProcessing:
    ...
    def test_when_process_batch_with_tuples_then_returns_context(
        ...
        texts = [("Hello world", {"id": 1}), ("This is a test", {"id": 2})]
    ...
    def test_when_process_batch_with_entities_then_extracts_correctly(
        ...
        texts = ["Barack Obama was born in Hawaii.", "John Smith lives in New York."]
    ...
    def test_when_process_batch_with_whitespace_then_handles_correctly(
        ...
        texts = [" Leading whitespace", "Trailing whitespace ", "  Multiple   spaces  "]
    ...
    def test_when_process_batch_with_special_chars_then_works(self, stanza_nlp_engine):
...
class TestStanzaTokenizerConvertDoc:
    ...
    def test_when_convert_doc_called_then_returns_spacy_doc(self, stanza_nlp_engine):
    ...
    def test_when_convert_doc_preserves_linguistic_features(self, stanza_nlp_engine):
...
class TestStanzaBulkProcessIntegration:
    ...
    def test_when_process_batch_then_calls_bulk_process(
        ...
        try:
            texts = ["Text 1", "Text 2"]
            result = list(
                stanza_nlp_engine.process_batch(texts, language="en", batch_size=2)
            )
    ...
    def test_when_process_batch_with_large_batch_then_handles_correctly(
        ...
        result = stanza_nlp_engine.process_batch(texts, language="en", batch_size=16)
        result_list = list(result)
    ...
    def test_when_process_batch_batching_matches_batch_size(self, stanza_nlp_engine):
