...
def test_valid_us_driver_license_weak_WA():
    ...
    assert results[1].probability > 0.29 and results[1].probability < 0.41
...
def test_valid_us_driver_license_weak_WA_exact_Context():
    ...
    assert results[0].probability > 0.55 and results[0].probability < 0.91
...
def test_valid_us_driver_license_very_weak_digits():
    ...
    for result in results:
        assert result.probability > 0 and result.probability < 0.1
