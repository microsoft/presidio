...
def test_nlp_config_missing_nlp_engine_name():
    ...
    invalid_config = {"models": [{"lang_code": "en", "model_name": "en_core_web_lg"}]}
...
def test_nlp_config_models_empty_list():
    ...
    invalid_config = {"nlp_engine_name": "spacy", "models": []}
...
def test_nlp_config_model_not_dict():
    ...
    invalid_config = {"nlp_engine_name": "spacy", "models": ["en_core_web_lg"]}
...
def test_nlp_config_model_missing_model_name():
    ...
    invalid_config = {"nlp_engine_name": "spacy", "models": [{"lang_code": "en"}]}
        ...
        "recognizers": [
            {
                ...
                "patterns": [{"name": "pattern1", "regex": "test", "score": 0.5}],
            }
        ],
    }

    result = ConfigurationValidator.validate_recognizer_registry_configuration(
        valid_config
    )
...
def test_recognizer_registry_empty_recognizers_list():
    ...
    invalid_config = {"supported_languages": ["en"], "recognizers": []}
...
def test_analyzer_config_minimal():
    ...
    valid_config = {"supported_languages": ["en"]}
...
def test_analyzer_config_invalid_languages():
    ...
    invalid_config = {"supported_languages": ["invalid_lang"]}
...
def test_analyzer_config_invalid_recognizer_registry_nested():
    ...
    invalid_config = {
        "supported_languages": ["en"],
        "recognizer_registry": {"recognizers": []},  # Empty list not allowed
    }
...
def test_analyzer_config_threshold_at_boundaries():
    ...
    # Test 0.0
    config_zero = {"supported_languages": ["en"], "default_score_threshold": 0.0}
    validated = ConfigurationValidator.validate_analyzer_configuration(config_zero)
    assert validated["default_score_threshold"] == 0.0

    # Test 1.0
    config_one = {"supported_languages": ["en"], "default_score_threshold": 1.0}
