...
| language|string|no| Two characters of the desired language. E.g en, de|
...
| return_decision_process|bool|yes| Should the decision points within the analysis be returned as part of the response |
