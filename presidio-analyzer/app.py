...
from presidio_analyzer.analyzer_loader import PresidioAnalyzerLoader
...
class Server:
    ...
    def __init__(self):
        ...
        self.engine: AnalyzerEngine = PresidioAnalyzerLoader.load(conf_file=os.path.abspath("conf/analyzer.yaml"))
