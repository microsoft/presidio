...
from presidio_analyzer.improvable_pattern import ImprovablePattern
...
from presidio_analyzer.improvable_pattern_recognizer import ImprovablePatternRecognizer
