...
__all__ = ['CreditCardRecognizer', 'SpacyRecognizer', 'CryptoRecognizer',
           'DomainRecognizer', 'EmailRecognizer', 'IbanRecognizer',
           'IpRecognizer', 'NhsRecognizer', 'UsBankRecognizer',
