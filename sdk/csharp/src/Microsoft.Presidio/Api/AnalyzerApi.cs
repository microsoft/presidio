...
namespace Microsoft.Presidio.Api
{
    ...
    public partial class AnalyzerApi : IAnalyzerApi
    {
        ...
        /// <returns></returns>
        public AnalyzerApi(Microsoft.Presidio.Client.Configuration configuration)
        {
        ...
        public AnalyzerApi(Microsoft.Presidio.Client.ISynchronousClient client, Microsoft.Presidio.Client.IAsynchronousClient asyncClient, Microsoft.Presidio.Client.IReadableConfiguration configuration)
        {
        ...
        public Microsoft.Presidio.Client.ApiResponse<List<RecognizerResultWithAnalysis>> AnalyzePostWithHttpInfo(AnalyzeRequest analyzeRequest)
        {
            ...
            if (analyzeRequest == null)
                throw new Microsoft.Presidio.Client.ApiException(400, "Missing required parameter 'analyzeRequest' when calling AnalyzerApi->AnalyzePost");
        ...
        {
            Microsoft.Presidio.Client.ApiResponse<List<string>> localVarResponse = RecognizersGetWithHttpInfo(language);
            return localVarResponse.Data;
        }
        ...
        /// <param name="language">Two characters for the desired language in ISO_639-1 format (optional)</param>
        /// <returns>ApiResponse of List&lt;string&gt;</returns>
        public Microsoft.Presidio.Client.ApiResponse<List<string>> RecognizersGetWithHttpInfo(string language = default(string))
        {
            Microsoft.Presidio.Client.RequestOptions localVarRequestOptions = new Microsoft.Presidio.Client.RequestOptions();
            ...
            if (language != null)
            {
                localVarRequestOptions.QueryParameters.Add(Microsoft.Presidio.Client.ClientUtils.ParameterToMultiMap("", "language", language));
            }
        ...
        {
            Microsoft.Presidio.Client.ApiResponse<List<string>> localVarResponse = await RecognizersGetWithHttpInfoAsync(language, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;string&gt;)</returns>
        public async System.Threading.Tasks.Task<Microsoft.Presidio.Client.ApiResponse<List<string>>> RecognizersGetWithHttpInfoAsync(string language = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            Microsoft.Presidio.Client.ApiResponse<List<string>> localVarResponse = SupportedentitiesGetWithHttpInfo(language);
            return localVarResponse.Data;
        }
        ...
        /// <param name="language">Two characters for the desired language in ISO_639-1 format (optional)</param>
        /// <returns>ApiResponse of List&lt;string&gt;</returns>
        public Microsoft.Presidio.Client.ApiResponse<List<string>> SupportedentitiesGetWithHttpInfo(string language = default(string))
        {
            Microsoft.Presidio.Client.RequestOptions localVarRequestOptions = new Microsoft.Presidio.Client.RequestOptions();
        ...
        {
            Microsoft.Presidio.Client.ApiResponse<List<string>> localVarResponse = await SupportedentitiesGetWithHttpInfoAsync(language, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;string&gt;)</returns>
        public async System.Threading.Tasks.Task<Microsoft.Presidio.Client.ApiResponse<List<string>>> SupportedentitiesGetWithHttpInfoAsync(string language = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
