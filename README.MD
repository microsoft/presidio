...
*The top image (Input text) is the text sent to presidio. The bottom image (Anonymized text) shows the response in which every PII entity was replaced with a*
