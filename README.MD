...
![Presidio demo gif](docs/assets/demo.gif)
...
6. [Perform PII identification and anonymization in images using presidio-image-anonymizer](docs/image-anonymizer/index.md)
